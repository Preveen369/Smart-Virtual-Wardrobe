  ...
  return (
    <div className="w-full transition-all duration-300 flex flex-col items-center">
      ...
      {preview ? (
        <div className="relative w-full flex justify-center items-center mt-4">
          <div className="relative">
            <img
              src={preview}
              alt="Preview"
              className="h-[240px] w-[240px] object-contain rounded-lg shadow-md"
              style={{ display: "block" }}
            />
            <CloseCircleOutlined
        ...
        <Dragger
          {...uploadProps}
          className="w-full max-w-xs p-4 flex flex-col items-center justify-center text-center"
          style={{
        ...
        >
          <p className="ant-upload-drag-icon" style={{ width: '100%', display: 'flex', justifyContent: 'center' }}>
            <InboxOutlined
          ...
          <p
            ...
            style={{ color: isDarkMode ? "#e5e5e5" : "#333", width: '100%' }}
          >
            Click or drag an image here to upload
          </p>
          <p
            className="ant-upload-hint"
            style={{ fontSize: 12, color: isDarkMode ? "#a1a1aa" : "#666", width: '100%' }}
          >
